...
import { addPrice, removePrice } from '../../features/rides/ridesSlice';
...
const AddRides = ({
  ...
  setAddRides: React.Dispatch<SetStateAction<boolean>>;
}) => {
  ...
  // };
  const deletePrice = (data: string) => {
    dispatch(removePrice(data));
  };
  ...
  return (
    <div className=''>
      <form encType='multiplart/form-data' className='flex flex-col gap-6'>
        ...
        {/* <label htmlFor='images'>Rides Images</label>
        <input
          type='file'
          multiple
          name='image_upload'
          ...
          onChange={handleChange}
        /> */}
        <label htmlFor='rides'>Rides Name</label>
        <input
